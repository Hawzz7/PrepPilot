...
const Step1SetUp = ({ onStart }) => {
  ...
  const handleUploadResume = async () => {
    ...
    try {
      ...
      setRole(result.data.candidate?.role || "");
      setExperience(result.data.candidate?.experienceLevel || "");
      setProjects(result.data.projects?.map((project) => project.title) || []);
          ...
          <div className="space-y-6">
            ...
            {!analysisDone && (
              <motion.div
                ...
                className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center cursor-pointer hover:border-blue-500 hover:bg-green-50 transition "
              >
            ...
            {analysisDone && (
              <motion.div className="bg-green-50 border border-green-300 rounded-xl p-5 space-y-4">
                <div className="bg-green-100 text-green-700 p-3 rounded-lg font-medium">
                  ✅ Resume analyzed successfully.
                  <br />
                  Your resume has been indexed for AI-powered interview
                  generation.
                </div>
