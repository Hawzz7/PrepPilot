...
const Home = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      desc: "Real Interview pressure with time constraints.",
    },
  ];
      ...
      <div className="flex-1 px-6 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-28">
            ...
            >
              Role-based AI mock interviews with adaptive difficulty,
              intelligent follow-up questions, and real-time performance
              insights.
            </motion.p>
